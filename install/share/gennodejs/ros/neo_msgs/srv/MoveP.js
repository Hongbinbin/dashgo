...
class MovePRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovePRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovePRequest
    let len;
    let data = new MovePRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovePRequest(null);
...
class MovePResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovePResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovePResponse
    let len;
    let data = new MovePResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovePResponse(null);
...
module.exports = {
  ...
  datatype() { return 'neo_msgs/MoveP'; }
};
