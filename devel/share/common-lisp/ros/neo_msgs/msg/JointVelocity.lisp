...
(cl:defmethod cl:initialize-instance :after ((m <JointVelocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointVelocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neo_msgs-msg:<JointVelocity> is deprecated: use neo_msgs-msg:JointVelocity instead.")))
