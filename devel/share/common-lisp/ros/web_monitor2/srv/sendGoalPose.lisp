...
(cl:in-package web_monitor2-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <sendGoalPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sendGoalPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name web_monitor2-srv:<sendGoalPose-request> is deprecated: use web_monitor2-srv:sendGoalPose-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <sendGoalPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader web_monitor2-srv:pose-val is deprecated.  Use web_monitor2-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sendGoalPose-request>)))
  ...
  "web_monitor2/sendGoalPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sendGoalPose-request)))
  "Returns string type for a service object of type 'sendGoalPose-request"
  "web_monitor2/sendGoalPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <sendGoalPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sendGoalPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name web_monitor2-srv:<sendGoalPose-response> is deprecated: use web_monitor2-srv:sendGoalPose-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <sendGoalPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader web_monitor2-srv:status-val is deprecated.  Use web_monitor2-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sendGoalPose-response>)))
  ...
  "web_monitor2/sendGoalPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sendGoalPose-response)))
  "Returns string type for a service object of type 'sendGoalPose-response"
  "web_monitor2/sendGoalPoseResponse")
